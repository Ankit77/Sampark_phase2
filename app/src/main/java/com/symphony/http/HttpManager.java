...
//	private String HTTP_ENDPOINT =HTTP_PROTOCOL+HTTP_SERVER; 
	...
	*/
        ...
        context.getContentResolver().insert(Uri.parse("content://com.symphony.database.DBProvider/addDistributer"),
    ...
    public void updateCheckStatus(ContentValues updateValue, String id) {
        ...
        int resVal = context.getContentResolver().update(Uri.parse("content://com.symphony.database.DBProvider/updateCheckFlagStatus"),
