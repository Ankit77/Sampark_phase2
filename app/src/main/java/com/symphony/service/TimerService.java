...
//        }
        ...
        mTimer = new CountDownTimer(e_sampark.getSharedPreferences().getLong("COUNTDOWNTIMER", 0), 1000) {
            @Override
            public void onTick(long millisUntilFinished) {
                mCurrentMillis = millisUntilFinished;
                SharedPreferences.Editor editor = e_sampark.getSharedPreferences().edit();
                editor.putLong("COUNTDOWNTIMER", millisUntilFinished);
                editor.commit();
                postTime(mCurrentMillis);
                Log.e("TimerService", "Time is." + mCurrentMillis);
            }
            ...
            public void onFinish() {
                postTime(0);
                SharedPreferences.Editor editor = e_sampark.getSharedPreferences().edit();
                editor.putLong("COUNTDOWNTIMER", 0);
                ...
                Log.e("TimerService", "Time is. finish");
